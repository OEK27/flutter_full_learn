...
import 'package:flutter_full_learn/300/generic_learn.dart';
...
void main() {
  ...
  test('List best of', () {
    ...
    users.take(5);
    users.remove(const GenericUser('vb1', '11', 10));
    users.removeAt(2);
    ...
    users.expand((element) => [const GenericUser('a', '1', 22)]);
  ...
  test('List best of with collection', () {
    ...
    users.sample(3);
    print(users.first == const GenericUser('vb1', '11', 10));
    users.contains(const GenericUser('vb1', '11', 10));
