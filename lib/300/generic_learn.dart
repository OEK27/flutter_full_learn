...
class UserManagement<T extends AdminUser> {
  ...
  int calculateMoney(List<GenericUser> users) {
    ...
    int initaleValue = admin.role == 1 ? admin.money : 0;

    final sumMoney =
        users.map((e) => e.money).fold<int>(initaleValue, (previousValue, element) => previousValue + element);
    // ignore: no_leading_underscores_for_local_identifiers
    final _money = users.fold<int>(initaleValue, (previousValue, element) => previousValue + element.money);
    return _money;
  }
