      ...
      body: Column(
        children: [
          ...
          FloatingActionButton(
            onPressed: () {
              // servise istek at
              // sayfanın rengini düzenle vb müşteri isteklerini yapmamıza yarar.
            },
          ...
          OutlinedButton.icon(onPressed: () {}, icon: const Icon(Icons.abc), label: const Text('merhaba')),
          ...
          ElevatedButton(
              ...
              child: Padding(
                ...
                child: Text('Place Bid', style: Theme.of(context).textTheme.headline4),
              ))
        ],
      ),
    );
