    ...
    return Scaffold(
      body: ListView.builder(
        itemBuilder: (context, index) {
          return TextButton(
            onPressed: () async {
              final response = await navigateToWidgedNormal<bool>(
                  context,
...
mixin NavigatorManager {
  void navigateToWidged(BuildContext context, Widget widget) {
...
Future<T?> navigateToWidgedNormal<T>(BuildContext context, Widget widget) {
